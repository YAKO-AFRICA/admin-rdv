...
$etat2 = GetParameter::FromArray($_REQUEST, 'j');
...
$liste_rdvs = $fonction->getSelectRDVAfficher($etat, $etat2);
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-12 col-sm-12">
							<div class="title">
								<h4>Liste des Rendez-vous Expirés</h4>
							</div>
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">
										Liste des Rendez-vous Expirés </li>
								</ol>
							</nav>
						</div>
					</div>
				...
				<div class="card-box mb-30">
					<div class="pd-20">
						<h4 class="text-center text-uppercase" style="color:info; "> Liste des Rendez-vous Expirés</h4>
					</div>
					<div class="pb-20">
